...
function renderSupportTickets(container) {
  ...
  <div style="max-width:1200px; margin:0 auto; padding:24px; position:relative; border-radius:12px; box-shadow: 0 2px 3px rgba(0, 0, 0, 0.1);">
    <div style="display:flex;justify-content:space-between;align-items:flex-start;margin-bottom:24px;">
      <div>
        <h1 style="margin:0 0 6px;font-size:20px;font-weight:700;font-family:var(--font-family);color:var(--heading-color);">My Support Tickets</h1>
      ...
      <button id="openCreateTicket" style="
        ...
        color:var(--axentra-btn-text-color);
        border:1px solid var(--axentra-btn-border-color, var(--axentra-btn-background-color));
        border-radius:6px;
        padding:10px 16px;
        font-size:14px;
        font-weight:500;
        cursor:pointer;
        font-family:var(--axentra-secondaryFontFamily, var(--axentra-font-family, inherit));
...
function statCard(label, value) {
  ...
  const cardTheme = {
    "Open Tickets": {
      iconBg: "var(--axentra-card-text-background-color)",
      iconColor: "var(--axentra-btn-background-color)",
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"></circle><polyline points="12 6 12 12 16 14"></polyline></svg>`
    },

    "In Progress": {
      iconBg: "var(--axentra-card-text-background-color)",
      iconColor: "var(--axentra-btn-background-color)",
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="3"></circle></svg>`
    },
    ...
    "Resolved": {
      iconBg: "var(--axentra-card-text-background-color)",
      iconColor: "var(--axentra-btn-background-color)",
      icon: `<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M9 12l2 2 4-4"></path><circle cx="12" cy="12" r="9"></circle></svg>`
    }
  };
  ...
  return `
  <div style="
    border:var(--axentra-card-border-size) solid var(--axentra-card-border-color);
...
function attachModalLogic() {
  const openCreateTicketButton = document.getElementById("openCreateTicket");

  openCreateTicketButton.onmouseenter = () => {
    openCreateTicketButton.style.background = "var(--axentra-btn-background-hover-color, var(--axentra-btn-background-color, #2563eb))";
    openCreateTicketButton.style.color = "var(--axentra-btn-text-hover-color, var(--axentra-btn-text-color, #fff))";
    openCreateTicketButton.style.borderColor = "var(--axentra-btn-border-color, var(--axentra-btn-background-hover-color, #2563eb))";
  };

  openCreateTicketButton.onmouseleave = () => {
    openCreateTicketButton.style.background = "var(--axentra-btn-background-color, #2563eb)";
    openCreateTicketButton.style.color = "var(--axentra-btn-text-color, #fff)";
    openCreateTicketButton.style.borderColor = "var(--axentra-btn-border-color, var(--axentra-btn-background-color, #2563eb))";
  };

  openCreateTicketButton.onclick =
