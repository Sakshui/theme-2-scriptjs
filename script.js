...
function statCard(label, value) {
  const cardTheme = {
    "Open Tickets": {
      iconBg: "var(--axentra-card-text-background-color, #dbeafe)",
      iconColor: "var(--axentra-btn-background-color, #2563eb)",
    ...
    "In Progress": {
      iconBg: "var(--axentra-card-text-background-color, #ede9fe)",
      iconColor: "var(--axentra-btn-background-color, #9333ea)",
    ...
    Resolved: {
      iconBg: "var(--axentra-card-text-background-color, #ffedd5)",
      iconColor: "var(--axentra-btn-background-color, #ea580c)",
  ...
  return `
  <div style="
    border:var(--axentra-card-border-size, 1px) solid var(--axentra-card-border-color, #e5e7eb);
    border-radius:var(--axentra-card-border-radius, 12px);
    padding:14px;
    background:var(--axentra-card-background-color, #f9fafb);
    display:flex;
    align-items:center;
    gap:12px;
    min-height:75px;
    font-family:var(--axentra-card-font-family, var(--axentra-font-family, inherit));
  ">
    <div style="
      width:36px;
      height:36px;
    ...
    <div>
      <div style="
        font-size:22px;
        font-weight:600;
        color:var(--axentra-card-heading-color, #111827);
        line-height:1;
        text-align:left;
      ">
        ${value}
      ...
      <div style="
        font-size:14px;
        color:var(--axentra-card-label-color, #6b7280);
        font-weight:500;
        margin-top:2px;
      ">
        ${label}
